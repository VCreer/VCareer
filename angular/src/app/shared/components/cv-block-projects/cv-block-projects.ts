...
@Component({
  selector: 'app-cv-block-projects',
  standalone: true,
  imports: [CommonModule, FormsModule, ReactiveFormsModule],
  templateUrl: './cv-block-projects.html',
  styleUrls: ['./cv-block-projects.scss']
})
export class CvBlockProjectsComponent implements OnInit {
