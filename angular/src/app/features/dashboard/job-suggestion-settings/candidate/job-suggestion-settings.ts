...
export class JobSuggestionSettingsComponent implements OnInit {
   ...
   * Follow mapping từ job-detail.ts (618-632)
   */
  loadExperienceOptions(): void {
    this.experienceOptions = [
      { value: '0', label: 'Không yêu cầu' },      // None
      { value: '1', label: 'Dưới 1 năm' },         // Under1
      { value: '2', label: '1 năm' },              // Year1
      { value: '3', label: '2 năm' },              // Year2
      { value: '4', label: '3 năm' },              // Year3
      { value: '5', label: '4 năm' },              // Year4
      { value: '6', label: '5 năm' },              // Year5
      { value: '7', label: '6 năm' },              // Year6
      { value: '8', label: '7 năm' },              // Year7
      { value: '9', label: '8 năm' },              // Year8
      { value: '10', label: '9 năm' },             // Year9
      { value: '11', label: '10 năm' },            // Year10
      { value: '12', label: 'Trên 10 năm' }        // Over10
    ];
  }
