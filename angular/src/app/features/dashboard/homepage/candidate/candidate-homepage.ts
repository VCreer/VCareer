...
import { JobApiService, JobSearchInputDto, JobViewDto, PagedResultDto } from '../../../../proxy/api/job.service';
...
export class CandidateHomepageComponent implements OnInit {
  ...
  updateCategoryPagination() {
    this.totalCategoryPages = Math.ceil(this.mockCategoriesForSection.length / this.categoriesPerPage);
  }
