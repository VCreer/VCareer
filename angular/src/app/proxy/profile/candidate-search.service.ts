...
import type { SearchCandidateInputDto, CandidateSearchResultDto, SendConnectionRequestDto } from '../dto/profile/models';
...
export class CandidateSearchService {
  ...
  getCandidateById = (candidateId: string, config?: Partial<Rest.Config>) =>
    this.restService.request<any, CandidateSearchResultDto>({
      method: 'GET',
      url: `/api/app/candidate-search/${candidateId}`,
    },
    { apiName: this.apiName,...config });
